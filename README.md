...
Semantic HTML is HTML that has tags with meaning.
...
Git saves different versions allowing you to undo or redo changes if mistakes are made

5. Define mobile-first design in your own words.

Designing at the smallest screen size first
